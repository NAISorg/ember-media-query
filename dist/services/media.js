...
class Media extends Service {
  static {
    g(this.prototype, "_mockedBreakpoints", [tracked], function () {
      return ['desktop'];
    });
  }
  #_mockedBreakpoints = (i(this, "_mockedBreakpoints"), void 0);
  /**
  ...
  is(breakpointNames) {
    const matches = name => {
      if (!this.matchers[name]) {
        throw new Error(`Breakpoint "${name}" not defined on the media service`);
      }
